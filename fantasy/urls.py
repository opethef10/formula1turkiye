...
urlpatterns = [
    ...
    path('<slug:champ>/teams/create/', views.TeamCreateView.as_view(), name='team_form'),
    path('<slug:champ>/teams/update/', views.NewTeamUpdateView.as_view(), name='new_team_update'),
