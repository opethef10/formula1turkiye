...
urlpatterns = [
    ...
    path('<str:series>/<int:year>/tahmin/', views.TeamListView.as_view(), name='team_list'),
    path('<str:series>/<int:year>/tahmin/new/', views.NewTahminView.as_view(), name='new_team_form'),
]
