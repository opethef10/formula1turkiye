...
class QuestionAdmin(SelectRelatedModelAdmin):
...
class TahminAdmin(SelectRelatedModelAdmin):
    list_select_related = ["race", "race__championship", "user"]
    related_fields = {
        'race': {
            'model': Race,
            'related_fields': ["championship"],
...
admin.site.register(Tahmin, TahminAdmin)
