...
patterns = [
    ...
    path('tahmin/', TemplateView.as_view(template_name="tahmin/championship_list.html"), name='tahmin_ligi'),
    path("contact/", ContactView.as_view(), name='contact'),
    path("pages/", include("django.contrib.flatpages.urls")),
    path('__summernote/', include('django_summernote.urls')),
    path('fantasy/', TemplateView.as_view(template_name="fantasy/championship_list.html"), name='fantasy_lig'),
